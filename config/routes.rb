...
#                          api_v1_movie GET    /api/v1/movies/:id(.:format)                                                             api/v1/movies#show
#                    api_v1_user_movies GET    /api/v1/favorites(.:format)                                                              api/v1/user_movies#index
#                                       POST   /api/v1/favorites(.:format)                                                              api/v1/user_movies#create
#                     api_v1_user_movie GET    /api/v1/favorites/:id(.:format)                                                          api/v1/user_movies#show
#                                       DELETE /api/v1/favorites/:id(.:format)                                                          api/v1/user_movies#destroy
...
Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      resources :user_movies, path: 'favorites', except: [:update]
    end
  end
end
